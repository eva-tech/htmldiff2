...
"""
    ...
    <div class="diff">Foo <del data-diff-id="1"><b>bar</b></del><ins data-diff-id="1"><i>bar</i></ins> baz</div>

    >>> print(render_html_diff('Foo bar baz', 'Foo baz'))
    <div class="diff">Foo <del data-diff-id="1">bar\xa0</del>baz</div>

    >>> print(render_html_diff('Foo baz', 'Foo blah baz'))
    <div class="diff">Foo <ins data-diff-id="1">blah\xa0</ins>baz</div>

    >>> print(render_html_diff('<img src="pic0.jpg"/>', '<img src="pic1.jpg"/>'))
    <div class="diff"><img src="pic1.jpg" class="tagdiff_replaced" data-old-src="pic0.jpg" data-diff-id="1"></div>
